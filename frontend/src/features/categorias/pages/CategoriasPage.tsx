...
export function CategoriasPage() {
  ...
  const handleAbrirModalEdicao = (categoria: Categoria) => {
  ...
  const handleSalvarCategoria = async (dadosCategoria: any) => {
    try {
      if (modoEdicao && categoriaEditando) {
        await atualizarCategoria(categoriaEditando.id, dadosCategoria);
      } else {
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <p className="text-gray-600 mb-6">
                ...
                <strong>{categoriaParaDeletar.nome}</strong>? Esta ação não pode ser desfeita.
              </p>
